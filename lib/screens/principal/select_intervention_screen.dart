...
class SelectInterventionScreen extends ConsumerStatefulWidget {
  ...
  const SelectInterventionScreen({
    super.key,
    required this.flag,
    required this.user,
  });
  ...
  @override
  ConsumerState<SelectInterventionScreen> createState() =>
      _SelectInterventionScreenState();
}

class _SelectInterventionScreenState
    extends ConsumerState<SelectInterventionScreen> {
                        ...
                        child: Row(
                          children: [
                            CircleAvatar(
                              ...
                              backgroundImage:
                                  (widget.flag.studentPhotoUrl != null &&
                              ...
                              child:
                                  ...
                                  ? Icon(
                                      Icons.person,
                                      color: widget.flag.category.accent,
                                      size: 24,
                                    )
                                  : null,
                            ),
                        ...
                        child: const Row(
                          children: [
                            Icon(
                              Icons.info_outline,
                              size: 16,
                              color: AppColors.attendanceAccent,
                            ),
                            SizedBox(width: 8),
                            Expanded(
                              child: Text(
